...
public class Robot {
	...
	public void update() {
		...
		if (speedX < 0)
			centerX += speedX; // speed added to center
		...
		rect.setRect(centerX - 34, centerY - 63, 68, 63); // top
		rect2.setRect(rect.getX(), rect.getY() + 63, 68, 64); // bottom
		rect3.setRect(rect.getX() - 26, rect.getY() + 32, 26, 20); // left
		rect4.setRect(rect.getX() + 68, rect.getY() + 32, 26, 20); // right
